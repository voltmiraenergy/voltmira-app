 ...
 *
 * VENDORED COPY for this standalone Studio package — identical to
 * `@voltmira/engine` in the main repo (engine/engine.js). If you're dropping
 * this into the VoltMira app, delete this file and point the three imports
 * (studio-kit.jsx, site-layout/page.jsx, bankability/page.jsx) back at
 * "@voltmira/engine".
 *
