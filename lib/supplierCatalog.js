...
// are a mock snapshot — there is no live distributor feed yet. `warrantyYears`,
// `dimensionsMm`, `weightKg` and (inverters only) `maxEfficiencyPct` are the
// same kind of illustrative-per-class estimate as `minMpptV`/`maxInputCurrentA`
// below — plausible for the equipment class, not transcribed from one real
// datasheet.
//
...
export const PANELS = [
  ...
  { id: "astronergy-555-bif", brand: "Astronergy", model: "ASTRO N5s Bifacial 555W", watt: 555, voc: 46.6, isc: 14.92, vmp: 39.1, imp: 14.2, cells: 132, eff: 22.28, tempCoeff: -0.26, price: 96, stock: 55, leadDays: 21, supplierId: "eurovolt", warrantyYears: 15, dimensionsMm: { w: 2094, h: 1134, d: 33 }, weightKg: 27.2, photoUrl: "https://www.astronergy.com/wp-content/uploads/2026/06/CHSM66RNDGF-BH.png" },
  { id: "hyundai-h-415", brand: "Hyundai Energy", model: "HiE-S415VG", watt: 415, voc: 37.9, isc: 13.95, vmp: 31.6, imp: 13.13, cells: 108, eff: 21.3, tempCoeff: -0.3, price: 64, stock: 210, leadDays: 0, supplierId: "nordsun", warrantyYears: 12, dimensionsMm: { w: 1903, h: 1134, d: 30 }, weightKg: 21.0, photoUrl: "https://www.pvxchange.com/media/image/product/12450/md/solarmodule-hyundai-hie-s415vg-996000293.jpg" },
];
...
export const INVERTERS = [
  ...
  { id: "huawei-sun2000-10ktl", brand: "Huawei", model: "SUN2000-10KTL-M1", kw: 10, type: "string", mppt: 2, phases: 3, maxDcV: 1100, minMpptV: 200, maxInputCurrentA: 15, price: 980, stock: 22, leadDays: 14, supplierId: "eurovolt", warrantyYears: 5, maxEfficiencyPct: 98.6, dimensionsMm: { w: 525, h: 470, d: 146 }, weightKg: 22, photoUrl: "https://solar.huawei.com/admin/asset/v1/pro/view/bcf9419a00e44d1ea412454838446a1e.png" },
  { id: "growatt-min6000tl-xh", brand: "Growatt", model: "MIN 6000TL-XH", kw: 6, type: "hybrid", mppt: 2, phases: 1, maxDcV: 600, minMpptV: 80, maxInputCurrentA: 16, price: 640, stock: 41, leadDays: 0, supplierId: "nordsun", warrantyYears: 10, maxEfficiencyPct: 97.6, dimensionsMm: { w: 394, h: 300, d: 130 }, weightKg: 13, photoUrl: "https://us.growatt.com/upload/image/20220824/5b704433ede360112a868c9e26f77545.png" },
  { id: "sofar-hyd20ktl-3ph", brand: "Sofar", model: "HYD 20KTL-3PH", kw: 20, type: "hybrid", mppt: 2, phases: 3, maxDcV: 1000, minMpptV: 180, maxInputCurrentA: 26, price: 2650, stock: 9, leadDays: 21, supplierId: "eurovolt", warrantyYears: 10, maxEfficiencyPct: 98.0, dimensionsMm: { w: 525, h: 470, d: 235 }, weightKg: 35, photoUrl: "https://www.sofarsolar.com/upload/image/20241108/1731029433781095983.png" },
  { id: "solis-s6-gr1p", brand: "Solis", model: "S6-GR1P(3-10)K", kw: 5, type: "string", mppt: 2, phases: 1, maxDcV: 600, minMpptV: 100, maxInputCurrentA: 13.5, price: 520, stock: 38, leadDays: 0, supplierId: "nordsun", warrantyYears: 5, maxEfficiencyPct: 97.8, dimensionsMm: { w: 365, h: 290, d: 145 }, weightKg: 11, photoUrl: "https://cmsdata.solisinverters.com/uploads/image/20230424/8lJjqfwOaAroVGzMFmM6B9Ay1ee4YCFcJPL0ABUP.png" },
  { id: "huawei-sun2000-100ktl", brand: "Huawei", model: "SUN2000-100KTL-M2", kw: 100, type: "string", mppt: 10, phases: 3, maxDcV: 1100, minMpptV: 200, maxInputCurrentA: 26, price: 8200, stock: 4, leadDays: 35, supplierId: "eurovolt", warrantyYears: 5, maxEfficiencyPct: 98.6, dimensionsMm: { w: 1075, h: 750, d: 340 }, weightKg: 100, photoUrl: "https://solar.huawei.com/-/media/SolarV4/solar-version2/asia-pacific/cn/professionals/all-products/ci/smart-pv-controller/SUN2000-150K-MG0-ZH/SUN2000-150K-MG0-ZH.png" },
...
export const BATTERIES = [
  { id: "pylontech-us5000x2", brand: "Pylontech", model: "US5000 × 2", kwh: 9.6, vdc: 48, chem: "LiFePO₄", chemClass: "LFP", cycles: 6000, price: 2380, stock: 26, leadDays: 0, supplierId: "nordsun", warrantyYears: 10, dimensionsMm: { w: 442, h: 132, d: 420 }, weightKg: 88, photoUrl: "https://www.nkon.nl/media/catalog/product/cache/634f00c0cac7a25d9ea011187773489b/u/s/us5000c_1.png" },
  { id: "deye-selb", brand: "Deye", model: "SE-G5.1Pro", kwh: 5.12, vdc: 51.2, chem: "LiFePO₄", chemClass: "LFP", cycles: 6000, price: 1290, stock: 33, leadDays: 0, supplierId: "nordsun", warrantyYears: 10, dimensionsMm: { w: 600, h: 650, d: 150 }, weightKg: 46, photoUrl: "https://7sun.eu/wp-content/uploads/2025/02/Modul-bateryjny-DEYE-SE-G5.1-PRO-B-515-kWh-LV.jpg" },
  { id: "dyness-powerbox", brand: "Dyness", model: "Powerbox H10", kwh: 4.8, vdc: 51.2, chem: "LiFePO₄", chemClass: "LFP", cycles: 6000, price: 1180, stock: 29, leadDays: 7, supplierId: "nordsun", warrantyYears: 10, dimensionsMm: { w: 450, h: 400, d: 130 }, weightKg: 44, photoUrl: "https://www.dyness.com/Public/Uploads/uploadfile/images/20240328/powerboxProzhushitu.png" },
  { id: "huawei-luna2000", brand: "Huawei", model: "LUNA2000-5-E0", kwh: 5.0, vdc: 50, chem: "LiFePO₄", chemClass: "LFP", cycles: 6000, price: 1340, stock: 20, leadDays: 14, supplierId: "eurovolt", warrantyYears: 10, dimensionsMm: { w: 600, h: 450, d: 150 }, weightKg: 48, photoUrl: "https://solar.huawei.com/admin/asset/v1/pro/view/f5e0c1c5666748f89154729f71fd9f6a.png" },
  { id: "pylontech-forceh2", brand: "Pylontech", model: "Force H2", kwh: 15.0, vdc: 51.2, chem: "LiFePO₄", chemClass: "LFP", cycles: 8000, price: 3650, stock: 11, leadDays: 21, supplierId: "eurovolt", warrantyYears: 10, dimensionsMm: { w: 600, h: 600, d: 200 }, weightKg: 140, photoUrl: "https://www.offgridtec.com/media/f2/ff/c5/1681796074/2-88-016800.jpg" },
...
export const MOUNTS = [
  { id: "k2-singlerail", brand: "K2 Systems", model: "SingleRail 48 / Speed Rail", type: "roof, tile hooks", eurPerKw: 60, stock: 999, leadDays: 0, supplierId: "nordsun", warrantyYears: 12, photoUrl: "https://k2-systems.com/wp-content/uploads/2022/03/SingleRail-title.jpg" },
  { id: "schletter-rapid16", brand: "Schletter", model: "Rapid16", type: "roof, trapezoidal sheet", eurPerKw: 55, stock: 999, leadDays: 7, supplierId: "eurovolt", warrantyYears: 12, photoUrl: "https://strapi.schletter-group.com/uploads/webloop_thumbnail_pitchedroof_d123154512.jpg" },
  ...
  { id: "k2-crossrail", brand: "K2 Systems", model: "CrossRail — ground / carport", type: "ground mount / carport", eurPerKw: 140, stock: 999, leadDays: 21, supplierId: "eurovolt", warrantyYears: 15, photoUrl: "https://k2-systems.com/wp-content/uploads/2022/08/GM-Header-1.jpg" },
];
