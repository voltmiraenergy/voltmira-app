...
const LEADS = [
  { name: "Grigore Cebotari", phone: "+373 691 22 145", email: "",                             channel: "whatsapp",  status: "new",       hot: true,  note: "Vrea 6 kW + baterie — a scris pe WhatsApp.", days: 1 },
  { name: "Natalia Cazacu",   phone: "",                email: "natalia.cazacu@gmail.com",     channel: "website",   status: "new",       hot: true,  note: "Formular pe site — acoperiș 120 m² în Chișinău.", days: 2 },
  { name: "Sergiu Vasilache", phone: "+373 601 90 322", email: "",                             channel: "referral",  status: "contacted", hot: false, note: "Recomandat de un vecin din Bălți.", days: 4 },
  { name: "Dumitru Sîrbu",    phone: "+373 678 41 208", email: "",                             channel: "coldcall",  status: "new",       hot: false, note: "Apel la rece — interesat pentru primăvară.", days: 6 },
  { name: "Ioana Marinescu",  phone: "+40 744 512 003", email: "ioana.m@outlook.com",          channel: "google",    status: "contacted", hot: false, note: "Caută ofertă pentru casă nouă în Iași.", days: 9 },
  { name: "Victor Ganea",     phone: "+373 688 77 214", email: "",                             channel: "facebook",  status: "new",       hot: false, note: "A comentat la postarea cu proiectul din Ungheni.", days: 12 },
  { name: "Mihai Roșca",      phone: "+40 722 908 441", email: "mihai.rosca@yahoo.com",        channel: "instagram", status: "contacted", hot: false, note: "Vrea și încărcător EV inclus în ofertă.", days: 16 },
];
...
export async function createDemoWorkspace(lang = "ro") {
  ...
  await admin.from("leads").insert(LEADS.map((l) => ({
    ...
    note: l.note, hot: l.hot, source: "manual", channel: l.channel,
